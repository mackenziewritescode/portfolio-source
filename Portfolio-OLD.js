...
function App() {
  ...
  window.onload = () => {
    if (window.location.hash === "#page-2") {
      page2Animations(page2Count, "page-2");
    }
  };

  page2Animations(page2Count, currentPage);
  ...
  // if (!page2Animation) {
  //   if (page2Intersection && page2Intersection.intersectionRatio > 0.5) {
  ...
  // if (!page4Animation) {
  //   if (page4Intersection && page4Intersection.intersectionRatio > 0.5) {
  ...
  return (
    <div id="portfolio-wrapper">
      {/* --------------------------------------------------  PAGE 1  */}
      <div id="page-1" className="page" ref={page1Ref}>
      ...
      <div id="page-3" className="page" ref={page3Ref}>
        ...
        <div id="project-wrap">
          ...
          <div className="project">
            ...
            <p className="project-description">
              An infinite-scrolling photo app using React, Node and Unsplash
              API.
            </p>
            <a
              className="project-link"
          ...
          <div className="project">
            ...
            <p className="project-description">
              A markup preview app that converts plain text written in Markdown
              to rich text in real time, using React.
            </p>
            <a
              className="project-link"
              href="http://www.sunkenworld.com/markdown-app"
